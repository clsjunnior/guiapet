...
CREATE UNIQUE INDEX TB_Permissao_CodPermissao_uindex
    ON TB_Permissao (CodPermissao);
...
CREATE UNIQUE INDEX TB_PermissaoUsuario_CodPermissaoUsuario_uindex
    ON TB_PermissaoUsuario (CodPermissaoUsuario);
CREATE INDEX TB_PermissaoUsuario_TB_Permissao_CodPermissao_fk
    ON TB_PermissaoUsuario (PermissaoCod);
CREATE INDEX TB_PermissaoUsuario_TB_Usuario_CodUsuario_fk
    ON TB_PermissaoUsuario (UsuarioCod);
...
CREATE INDEX Estabelecimento_Categoria
    ON TB_Estabelecimento (CategoriaCod);
CREATE UNIQUE INDEX TB_Estabelecimento_CNPJ_uindex
    ON TB_Estabelecimento (CNPJ);
CREATE UNIQUE INDEX TB_Estabelecimento_CodEstabelecimento_uindex
    ON TB_Estabelecimento (CodEstabelecimento);
CREATE INDEX TB_Estabelecimento_TB_Localizacao_CodLocalizacao_fk
    ON TB_Estabelecimento (LocalizacaoCod);
CREATE INDEX TB_Estabelecimento_TB_Usuario_fk
    ON TB_Estabelecimento (UsuarioCod);
...
CREATE UNIQUE INDEX TB_Avaliacao_CodAvaliacao_uindex
    ON TB_Avaliacao (CodAvaliacao);
CREATE INDEX TB_Avaliacao_TB_Estabelecimento_CodEstabelecimento_fk
    ON TB_Avaliacao (EstabelecimentoCod);
CREATE INDEX TB_Avaliacao_TB_Usuario_CodUsuario_fk
    ON TB_Avaliacao (UsuarioCod);
...
CREATE UNIQUE INDEX TB_Galeria_CodGaleria_uindex
    ON TB_Galeria (CodGaleria);
CREATE INDEX TB_Galeria_TB_Estabelecimento_CodEstabelecimento_fk
    ON TB_Galeria (EstabelecimentoCod);
...
CREATE UNIQUE INDEX TB_TagEstabelecimento_CodTagEstabelecimento_uindex
    ON TB_TagEstabelecimento (CodTagEstabelecimento);
CREATE INDEX TB_TagEstabelecimento_TB_Estabelecimento_fk
    ON TB_TagEstabelecimento (EstabelecimentoCod);
CREATE INDEX TB_TagEstabelecimento_TB_Tag_fk
    ON TB_TagEstabelecimento (TagCod);
