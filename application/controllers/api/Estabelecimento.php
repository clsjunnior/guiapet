...
class Estabelecimento extends CI_Controller
{
    ...
    public function recomendacao()
    {
        ...
        $config = [
            'idUser' => null,           // ID do usuario para realizar recomendação pelo seu historico
            'historicoCatQtde' => 10, // Quantidade de registros que vai se basear para categoria
            'historicoTagQtde' => 10, // Quantidade de registros que vai se basear para tags
            'totalResult' => 10,      // Total de resultados
